...
export const ArtDecoSvg = ({ children }: { children: ReactNode }) => {
  return (
    <div className="relative">
      ...
      {children}
      <svg
        className="absolute bottom-0 left-0 h-16 w-16 text-primary"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 100 100"
        fill="currentColor"
      >
      ...
      <svg
        className="absolute bottom-0 right-0 h-16 w-16 rotate-90 text-primary"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 100 100"
        fill="currentColor"
      >
